...
// Shows collectible image, name, campaign it is associated with, date released and date added to user's collection
// Allows user to delete selected collectibles from their collection
